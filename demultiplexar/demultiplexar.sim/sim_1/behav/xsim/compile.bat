...
REM
REM Generated by Vivado on Tue Dec 26 19:25:18 +0530 2023
...
echo "xvlog --incr --relax -prj demux_tb_vlog.prj"
call xvlog  --incr --relax -prj demux_tb_vlog.prj -log xvlog.log
