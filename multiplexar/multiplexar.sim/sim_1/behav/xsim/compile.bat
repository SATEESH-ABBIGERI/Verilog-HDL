...
REM
REM Generated by Vivado on Tue Jan 23 23:58:53 +0530 2024
...
echo "xvlog --incr --relax -prj mux_4_tb_vlog.prj"
call xvlog  --incr --relax -prj mux_4_tb_vlog.prj -log xvlog.log
